...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "dashboard.createFromTextDesc": "Script and storyboard generation from your idea, full video prep package",
    ...
    "dashboard.recentTopics": "Recent Topics",
    ...
    "topics.scriptCreatedDesc": "Topic selected and script initialized",
  ...
  ru: {
    ...
    "dashboard.subtitle": "Панель для создания и генерации видео, обзора последних трендов и новостей, а также просмотра списка скриптов для видео которое у вас уже в работе. Воспользуйтесь меню для доступа к другим разделам.",
    ...
    "dashboard.createFromTextDesc": "Генерация сценария и раскадровки по вашей идее, создание полного пакета подготовки ролика",
    ...
    "dashboard.recentTopics": "Последние топики",
    ...
    "topics.scriptCreatedDesc": "Топик выбран и скрипт создан",
